...
# reading the games.csv file using cat and then applying a while loop to read row by row
cat games.csv | while IFS="," read YEAR ROUND WINNER OPPONENT WINNER_GOALS OPPONENT_GOALS
do
    # inserting the data of GET WINNER TEAM NAME and eliminating the names of rows and columns 
      if [[ $WINNER != "winner" ]]
        then
          # get team name
